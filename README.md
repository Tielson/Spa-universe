...
Project created from figma. Made with SPA concepts, changing the default behavior of the redirect event, object orientation was also used for mapping routes.
